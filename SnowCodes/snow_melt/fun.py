...
def snowdepth(snow_at_start, measured_snow_next_period, satellite_data):
    ...
    """
    try:
        calc_snow = ArrayCalculations(snow_start_of_period=snow_at_start,
...
def compare_date(filename_one, filename_two):
    ...
    """
    # path attribute is not used and therefore set to a random value
    ...
    # CHANGE: reference to new function "get_date_format"
    if not manage_raster_one.get_date_format() == manage_raster_two.get_date_format():
