...
def get_band_paths(folder):
    """Extracts the pre-processed raster band paths for band from an input folder.

    :param folder: path where pre-processed raster paths are located
...
def calculate_snow_cover(folder, date):
    ...
    :param folder: Folder path where satellite images to use are located.
    The file name should have the sensing date in
